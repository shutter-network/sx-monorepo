...
test('capture engine-room panels for spacing review', async ({ page }) => {
  ...
  await page.screenshot({ path: resolve(OUT, '01-setup-and-collapsed.png'), fullPage: true });
  ...
  await page.screenshot({ path: resolve(OUT, '01b-setup-expanded.png'), fullPage: true });
  ...
  await page.screenshot({ path: resolve(OUT, '02-verified-collapsed.png'), fullPage: true });
  ...
  await page.screenshot({ path: resolve(OUT, '03-engine-room-expanded.png'), fullPage: true });
